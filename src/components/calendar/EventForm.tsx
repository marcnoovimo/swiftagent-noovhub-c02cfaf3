...
import { CalendarIcon, Clock, MapPin, User, X, Save } from 'lucide-react';
...
const eventSchema = z.object({
  ...
  type: z.enum(['appointment', 'meeting', 'showing', 'personal', 'other']),
...
const EventForm: React.FC<EventFormProps> = ({ open, onOpenChange, event }) => {
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="showing">Visite</SelectItem>
