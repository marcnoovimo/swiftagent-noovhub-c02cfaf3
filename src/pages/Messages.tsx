  ...
  return (
    <div className="container mx-auto px-4 py-8 animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">Consultez et répondez à vos messages</p>
      </div>
              ...
              <div
                ...
                className={`p-3 rounded-lg cursor-pointer transition-all ${
                  activeConversation.id === conversation.id
                    ? 'bg-noovimo-50 border-l-2 border-noovimo-500'
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex justify-between items-center mt-1">
                      ...
                      {conversation.lastMessage.unread && (
                        <span className="w-2 h-2 bg-noovimo-500 rounded-full ml-1"></span>
                      )}
                    </div>
                  </div>
                </div>
        ...
        <div className="md:col-span-2 flex flex-col h-[600px]">
              ...
              >
                <div className={`max-w-[75%] ${message.isOwn ? 'order-2' : 'order-1'}`}>
                  ...
                  <div className={`
                    p-3 rounded-lg 
                    ${message.isOwn 
                      ? 'bg-noovimo-500 text-white rounded-tr-none' 
          ...
          <div className="p-4 border-t border-border/50">
            <div className="flex items-center">
              ...
              <button
                className="p-2 bg-noovimo-500 text-white rounded-full"
